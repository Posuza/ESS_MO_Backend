...
class Province(Base):
    ...
    province_id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True, index=True)
    province_name: Mapped[str] = mapped_column(String(225), nullable=False)

...
from sqlalchemy import Boolean, Date, DateTime, Integer, String, Text, ForeignKey, func, text
...
class Employee(Base):
    ...
    name_prefix_id: Mapped[int] = mapped_column(Integer, ForeignKey("name_prefixs.prefix_id"), nullable=False)
    
    first_name: Mapped[str] = mapped_column(String(150), nullable=False)
    last_name: Mapped[str] = mapped_column(String(150), nullable=False)
    
    profile_image_path: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    profile_image_updated_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
    ...
    address_id: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey("address.address_id"), nullable=True)

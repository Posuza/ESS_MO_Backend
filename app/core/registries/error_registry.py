...
ERROR_REGISTRY: dict[str, dict[str, dict]] = {
    "AUTH": {
        ...
        "ER_AUTH_1006": {"http_status": 401, "error": "INVALID_CREDENTIALS", "message": "Incorrect Password.", "contacts": [{"team": "SEC_OPS", "email": "sec-ops@gutsess.com"}]},
        "ER_AUTH_1009": {"http_status": 404, "error": "EMPLOYEE_NOT_FOUND", "message": "Employee code not found in the system. Please contact Human Resources.", "contacts": [{"team": "HR_OPS", "email": "hr@gutsess.com"}]},
        "ER_AUTH_1010": {"http_status": 403, "error": "ACCOUNT_INACTIVE_FORGOT_PASSWORD", "message": "Employee account is inactive. Please contact Human Resources.", "contacts": [{"team": "HR_OPS", "email": "hr@gutsess.com"}]},
        "ER_AUTH_1011": {"http_status": 400, "error": "NO_EMAIL_REGISTERED", "message": "No registered email found for this employee code. Please contact Human Resources.", "contacts": [{"team": "HR_OPS", "email": "hr@gutsess.com"}]},
    },
    "CLIENT": {
    ...
    "DB": {
        ...
        "ER_DB_502": {"http_status": 503, "error": "HOST_BLOCKED", "message": "Database host is temporarily blocked due to connection errors. Please contact DB Admin.", "contacts": [{"team": "DB_ADMIN", "email": "db-admin@gutsess.com"}]},
